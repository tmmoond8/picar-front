      ...
      <Content isMobile={ui.queryMatch.Mobile}>
        <div>
          ...
          <ol>
            ...
            <li>
              "해지“라 함은 회사 또는 회원이 서비스 개통 후 이용계약을 해약하는
              것을 말합니다.
            </li>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              내용으로 약관을 개정하는 경우에는 공지 외에 회원정보에 등록된
            ...
            <li>
              "회원"이 개정약관에 동의하지 않는 경우 회사는 개정약관의 내용을
          ...
          <ol>
            <li>
              <p>
                ...
                작성한 게시물 등(이하 “게시물 등”이라 합니다)에 대한 저작권을
          ...
          <ol>
            <li>
              "회사"가 "회원"에 대한 통지를 하는 경우 본 약관에 별도 규정이 없는
              한 "회원"이 지정한 전자우편주소, 알림 메시지 등으로 할 수
              있습니다.
            </li>
            <li>
          ...
          <ol>
            <li>
              "회사"는 "회원"이 본 약관의 의무를 위반하거나 서비스의 정상적인
            ...
            <li>
              ...
              관련법을 위반한 경우에는 즉시 계약해지를 할 수 있습니다. 본 항에
              따른 계약해지 시 서비스 이용을 통해 획득한 혜택 등도 모두
          ...
          <ol>
            <li>
              ...
              게시물의 게시중단 및 삭제 등을 요청할 수 있으며, "회사"는 관련법에
              따라 조치를 취하여야 합니다.
            </li>
            <li>
          ...
          <ol>
            ...
            <li>
              "회사"는 서비스와 관련하여 회원에게 회사가 정한 이용조건에 따라
