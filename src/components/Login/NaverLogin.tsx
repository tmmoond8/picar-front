...
const NaverLogin: React.FC<{
  ...
  const handleNaverLogin = React.useCallback(() => {
    ...
    setTimeout(() => {
      if (isHybrid()) {
        Browser.open({
          url: `${env.REACT_APP_NAVER_LOGIN_BRIDGE_URL}?uuid=${uuid}`,
          windowName: 'naverLoginPage',
        });
      } else {
        const naverLoginUrl =
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path
          ...
          transform="translate(-200 -659) translate(0 462) translate(200 197)"
        />
        <g
          filter="url(#nl3reommma)"
          transform="translate(-200 -659) translate(0 462) translate(200 197)"
        >
          <path
            fill="#1EC800"
            d="M19.553 0.875L19.553 14.118 10.479 0.875 0.674 0.875 0.674 27.125 10.448 27.125 10.448 13.882 19.521 27.125 29.327 27.125 29.327 0.875z"
