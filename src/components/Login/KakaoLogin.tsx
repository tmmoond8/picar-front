...
export default function KakaoLogin(props: KakaoLoginProps): JSX.Element {
  ...
  const handleLogin = React.useCallback((result) => {
    const {
      id,
      kakao_account: {
        email,
  ...
  return <ReactKakaoLogin
    ...
    render={(props: any) => (
      <img src="https://noticon-static.tammolo.com/dgggcrkxq/image/upload/v1566815760/noticon/s1118wnuadritgbmm9by.png" onClick={props.onClick}/>
    )}
  />;
}